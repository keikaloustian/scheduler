...
describe("Form", () => {
  ...
  const { getByText } = render(<Form student={''} interviewers={interviewers} interviewer={1} onSave={onSave} />);
  ...
  it("validates that the interviewer cannot be null", () => {
    ...
    const { getByText } = render(<Form student="Lydia Miller-Jones" interviewers={interviewers} interviewer={null} onSave={onSave} />);
  ...
  it("calls onSave function when the name and interviewer is defined", () => {
    ...
    const { getByText, queryByText } = render(<Form student="Lydia Miller-Jones" interviewers={interviewers} interviewer={1} onSave={onSave} />);
